...
//       <img
//         src="/WhatsApp Image 2026-03-27 at 1.25.52 PM.jpeg"
//         alt="Brajesh Kumar"
//         style={{ width: "100%", height: "100%", objectFit: "cover" }}
//       />
//     </div>
//     {/* Flowers SVG */}
//     <div className="flower-svg" style={{ top: -15, right: -15 }}>
//       <svg viewBox="0 0 100 100">
//         <path d="M50 0 C 50 25 75 50 100 50 C 75 50 50 75 50 100 C 50 75 25 50 0 50 C 25 50 50 25 50 0" />
//       </svg>
//     </div>
//     <div className="flower-svg" style={{ bottom: -15, left: -15, animationDelay: "1.5s", opacity: 0.4 }}>
//       <svg viewBox="0 0 100 100">
//         <path d="M50 0 C 50 25 75 50 100 50 C 75 50 50 75 50 100 C 50 75 25 50 0 50 C 25 50 50 25 50 0" />
//       </svg>
//     </div>
...
//       {/* Hero Content */}
//       <div style={{
//         position: "relative", zIndex: 5, maxWidth: "80rem", margin: "0 auto", padding: "5rem 2rem", width: "100%",
...
//         {/* Hero Image */}
//         <div style={{ animation: "scaleIn .8s .6s cubic-bezier(.16,1,.3,1) both" }}>
//           <ImageFrame />
//         </div>
//       </div>
//     </section>
